...
class Sofa_Model(nn.Module):
    ...
    def __init__(self, normal_channel=False, feature_dim=128):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=2048, radius=0.1, nsample=32, in_channel=6+additional_channel, mlp=[64, 64, 128], group_all=False)
        self.sa2 = PointNetSetAbstraction(npoint=512, radius=0.2, nsample=64, in_channel=128 + 3, mlp=[128, 128, 256], group_all=False)
